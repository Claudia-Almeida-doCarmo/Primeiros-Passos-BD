...
CREATE TABLE IF NOT EXISTS `dbshoes`.`produto` (
  ...
  INDEX `fk_produto_funcionario_idx` (`funcionario_idfuncionario` ASC),
...
CREATE TABLE IF NOT EXISTS `dbshoes`.`fornecedor` (
  ...
  INDEX `fk_fornecedor_produto1_idx` (`produto_idproduto` ASC),
...
CREATE TABLE IF NOT EXISTS `dbshoes`.`cliente` (
  ...
  INDEX `fk_cliente_venda1_idx` (`venda_idvenda` ASC),
